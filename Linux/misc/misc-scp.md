...
Copy file from a remote host to local hostSCP example:
...
`scp -rusername@from_host:/remote/directory/ /local/directory/`

Copy directory from local host to a remote hos SCP examplet:

`scp -r /local/directory/ username@to_host:/remote/directory/`

Copy file from remote host to remote host SCP example:

`scp username@from_host:/remote/directory/file.txtusername@to_host:/remote/directory/`
...
- If you get a “Connection refused” error, try restarting the service on the destination host.
